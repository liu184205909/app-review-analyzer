...
| 文档 | 说明 | 适用人群 |
|------|------|---------|
| **[📦 部署指南](部署指南.md)** | Vercel 部署、数据库配置、功能开关 | ⭐⭐⭐ 所有用户 |
| **[🔐 OAuth 配置](OAUTH_SETUP.md)** | Google/Apple 第三方登录配置 | 需要 OAuth 的用户 |

### 📚 开发文档
| 文档 | 说明 | 适用人群 |
|------|------|---------|
| **[💻 开发指南](docs/开发指南.md)** | 完整的技术开发文档 | ⭐⭐⭐ 开发者 |
| **[🆓 免费数据源](docs/免费数据源.md)** | 数据源技术详情 | 开发者 |
| **[🗺️ 功能路线图](docs/功能路线图.md)** | 产品规划和路线图 | 产品经理 |

### 🔧 技术参考
| 文档 | 说明 |
|------|------|
| **[Prisma 数据库指南](docs/Prisma数据库字段指南.md)** | 数据库 JSON 字段使用 |
| **[第三方服务集成](docs/第三方服务集成指南.md)** | 付费数据源集成方案 |
...
| 用户类型 | 是否需要登录 | 分析次数 | 费用 | 特殊功能 |
|---------|------------|---------|------|---------|
| **访客** | ❌ | 1次/24小时 | 免费 | - |
| **Free** | ✅ | 3次/月 | 免费 | 保存历史、导出报告 |
| **Professional** | ✅ | ✅ 无限 | $29/月 | 竞品对比(3个)、优先支持 |
| **Team** | ✅ | ✅ 无限 | $99/月 | 竞品对比(5个)、API访问 |

> **注意**：Professional 和 Team 用户需要登录并订阅相应套餐才能使用无限分析功能。
