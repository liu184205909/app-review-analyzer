...
| 文档 | 用途 | 必读程度 |
|------|------|----------|
| **[README.md](./README.md)** | 项目介绍 + 快速开始 | ⭐⭐⭐ 必读 |
| **[开发指南.md](./开发指南.md)** | 完整安装配置 + 项目结构 | ⭐⭐⭐ 必读 |
| **[功能规划.md](./功能规划.md)** | 所有需求 + 优化方案 | ⭐⭐ 推荐 |

### 作为新手，你现在应该：

1. ✅ **阅读本 README** - 了解项目概况（你已经看完了！）
2. 📖 **打开 [开发指南.md](./开发指南.md)** - 按步骤完成安装配置
3. 🧪 **测试 Instagram iOS** - 验证功能正常
4. 🚀 **查看 [功能规划.md](./功能规划.md)** - 了解待开发功能
